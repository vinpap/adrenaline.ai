...
\begin{document}
    ...
    \begin{itemize}
        ...
        \begin{figure}[h!]
            ...
            \centering
            \caption{Définition des paramètres de déploiement intégré sur Azure}
            \centering
        \end{figure}
        \item la création de la ressource prendra quelques minutes. Lorsqu'elle est terminée, se rendre sur la page de la ressource Azure. Cliquer sur "Paramètres" à gauche puis se rendre dans la section "Variables d'environnement".
        \item Sur l'écran qui apparaît, créer cinq variables d'environnement \textbf{qui portent le même nom et ont les mêmes valeurs que les cinq variables définies plus haut}. La liste des valeurs devrait ressembler à ceci :
        \begin{figure}[h!]
            \includegraphics[width=12cm]{azure_4}
            \centering
            \caption{Liste des variables d'environnement à définir sur la ressource Azure}
            \centering
        \end{figure}
        \item La ressource sera automatiquement relancée. L'application est maintenant disponible via le lien présenté sur la page d'accueil de la ressource.
    \end{itemize}
